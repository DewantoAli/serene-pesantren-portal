	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'golden-gradient': 'linear-gradient(to right, #E1C78F, #D4AF37, #E1C78F)',
				'shimmer-gradient': 'linear-gradient(to right, rgba(255,255,255,0) 0%, rgba(255,255,255,0.2) 25%, rgba(255,255,255,0.2) 50%, rgba(255,255,255,0) 100%)',
			},
			boxShadow: {
